...
const Section5: FC = () => {
  const testimonials = [
    {
      descr:
        "“Kate's courses are a game changer. She's thorough, organized, and anyone—from beginners to experts—can learn something from her courses and take their skills to the next level.”",
  ...
  return (
    <section id="blog" className={scss.Section5}>
